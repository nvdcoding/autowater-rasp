...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Qmqtt" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Qmqtt_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
macro(_populate_Qmqtt_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Qmqtt_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Qmqtt)
    ...
    set(_Qt5Qmqtt_OWN_INCLUDE_DIRS "${_qt5Qmqtt_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Qmqtt_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQmqtt")
    set(Qt5Qmqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Qmqtt_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQmqtt/1.0.0"
        "${_qt5Qmqtt_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQmqtt/1.0.0/QtQmqtt"
    )
    ...
    _populate_Qmqtt_target_properties(DEBUG "libQt5Qmqtt.so.1.0.0" "" )
    ...
    macro(_populate_Qmqtt_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Qmqtt_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Qmqtt_check_file_exists(${imported_location})
